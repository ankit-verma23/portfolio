import { Brain, GamepadDirectional, Goal, GraduationCap, Users } from "lucide-react";
import React from "react";
import Education from "./AboutBox";
  ...
  return (
    <div className="w-full h-fit p-4">
      ...
      <div className="mt-4 flex items-center gap-10">
        <div className="flex gap-4 w-1/2 px-2 font-inter font-medium text-gray-400 tracking-wide text-[14px]">
          <div>
            <p>
        ...
        <div className="w-1/2 h-fit">
          <div className="grid grid-cols-2 grid-rows-2 gap-4">
            <div>
              <div className="w-70 h-full flex gap-4 cursor-pointer px-6 p-2 bg-[#0F1415] border py-6 border-white/10 rounded-xl ">
            ...
            <div>
              <div className="w-70 h-full cursor-pointer flex gap-4 px-6 p-2 bg-[#0F1415] border py-6 border-white/10 rounded-xl ">
